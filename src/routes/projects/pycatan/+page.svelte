...
<div class="flex flex-row content-center align-middle mt-4">
    <img class="h-auto sm:w-30 w-15 mt-5 mb-5 mr-8  object-cover rounded-md" src="https://raw.githubusercontent.com/Harry55494/pyCatan/refs/heads/master/icon.png" alt="Project Icon">
    <div class=" mt-5 mb-5 ">
        <h1 class="text-3xl font-bold mt-5 mb-3 dark:text-gray-50">pyCatan</h1>
