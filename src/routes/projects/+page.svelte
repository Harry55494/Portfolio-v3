...
<div class="m-auto dark:text-gray-50">
    ...
    <p class="mb-5 ml-0.5 text-gray-900 sm:text-base text-[14px] ">Projects and Recent Activity listed here are pulled live from my public <a href="https://github.com/harry55494" class="underline">GitHub profile</a> via GitHub's API. Data is cached for 5 minutes. </p>
